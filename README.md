...
<p align="center">
  ...
  <h3 align="center">Library Color</h3>
</p>
...
This a scriptable object who manage and store Colors with an enum or an int.
...
in Unity : Windows -> Package Manager -> + -> Add package from git url
2. Clone the repo
3. In the project windows : Create / ArchNet / Library / ColorLibrary.
5. When given in serialized field in controller script, you can access to :
- GetColor ( return color from an int)
